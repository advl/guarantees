 ...
 * and the verdict or the refusal mapped to an exit code, with the code a
 * set of them reduces to. Pure: the caller reads the report and dates it.
 */
...
export { default as worstCode } from "./worstCode.js";
